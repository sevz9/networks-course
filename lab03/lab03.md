...
Ответ
![alt text](https://github.com/sevz9/networks-course/blob/master/lab03/images/server_good.jpg)

Некорректный http://localhost:1234/test1.html
Ответ
![alt text](https://github.com/sevz9/networks-course/blob/master/lab03/images/server_bad.jpg)
...
Запускаем сервер командой
python3 multithread_server.py 1234

Далее аналогично с прошлым пунктом
...
ЗАДАЧИ 1 и 2
![alt text](https://github.com/sevz9/networks-course/blob/master/lab03/images/problems.jpg)
